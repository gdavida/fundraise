...
function fundraise17_scripts() {
	...
	wp_enqueue_script( 'ajax-mail', get_template_directory_uri() . '/js/ajax-mail.js', array(), '20151215', true );
	wp_enqueue_script( 'ajax-subscribe', get_template_directory_uri() . '/js/ajax-subscribe.js', array(), '20151215', true );
	wp_enqueue_script( 'googlemaps', "https://maps.googleapis.com/maps/api/js?key=AIzaSyC8hjTJwTaYk3q7ccXZ9SNl5F9Ey6UPEhg", '20151215', true );
	wp_enqueue_script( 'custom', get_template_directory_uri() . '/js/appai.map-2.js', array(), '20151215', true );
	wp_enqueue_script( 'custom', get_template_directory_uri() . '/js/main.js', array(), '20151215', true );
