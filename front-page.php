<?php get_header(''); ?>
        ...
        <!-- header area end -->
        <!-- slider area start -->
        <section id="slider-area" class="home-style-2 blue-grad-bg">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="promo-header-area text-center">
                            ...
                            <div class="swiper-container one animated fadeInUp wow" data-wow-delay="2s">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img src="<?php echo get_template_directory_uri() ?>/img/app-screenshots/11.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="swiper-slide">
                ...
                <div class="row">
                    <div class="col-sm-4 p-0 wow fadeIn" data-wow-duration="2s" data-wow-delay="1.2s">
                        <div class="awesome-feature one style-2 media">
                            ...
                            <div class="asesome-feature-details media-body">
                                ...
                                <p>Build or link your event calendar. Users easily save events to their personal calendars, and admins easily add, update, and push out reminders.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 p-0 wow fadeIn" data-wow-duration="2s" data-wow-delay="1.4s">
                        <div class="awesome-feature two style-2 media">
                            ...
                            <div class="asesome-feature-details media-body">
                                <h5>DONATION HUB</h5>
                                <p>Get financial support to the avenues you need it, while providing options for your supporters to direct their money to the places they need the most.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 p-0 wow fadeIn" data-wow-duration="2s" data-wow-delay="1.6s">
                        <div class="awesome-feature three style-2 media">
                            ...
                            <div class="asesome-feature-details media-body">
                                <h5>VOLUNTEER CENTER</h5>
                                <p>Put a call out for volunteers, send automated reminders, and connect with your supporters on the ways they are willing and able to commit their time.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4 p-0 wow fadeIn" data-wow-duration="2s" data-wow-delay="1.8s">
                        <div class="awesome-feature four style-2 media">
                            ...
                            <div class="asesome-feature-details media-body">
                                <h5>SWAG STORE</h5>
                                <p><!-- Forget meeting minimum orders, collecting payments, and coordinating deliveries.  -->We set you up with a small branded clothing store. The store's open 24/7. We handle payments and delivery. You kick back and get 20% back on all sales.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 p-0 wow fadeIn" data-wow-duration="2s" data-wow-delay="2s">
                        <div class="awesome-feature five style-2 media">
                            ...
                            <div class="asesome-feature-details media-body">
                                <h5>IDEA BOX</h5>
                                <p>Listen and learn from your community. Build avenues for dialogue and see how intentional inclusiveness helps make your organization stronger.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 p-0 wow fadeIn" data-wow-duration="2s" data-wow-delay="2.2s">
                        <div class="awesome-feature six style-2 media">
                            ...
                            <div class="asesome-feature-details media-body">
                                ...
                                <p>We gather statistics from your site's usage and share insights and tips. We offer automated campaigns and follow-up iterations to make sure you are always improving your community engagement.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="slider-image">
                                    <img src="<?php echo get_template_directory_uri() ?>/img/app-screenshots/7.jpg" alt="" class="img-responsive">
                                    <div class="preview-icon">
                                        <a href="<?php echo get_template_directory_uri() ?>/img/app-screenshots/7.jpg"><i class="icofont icofont-image"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="slider-image">
                                    <img src="<?php echo get_template_directory_uri() ?>/img/app-screenshots/6.jpg" alt="" class="img-responsive">
                                    <div class="preview-icon">
                                        <a href="<?php echo get_template_directory_uri() ?>/img/app-screenshots/6.jpg"><i class="icofont icofont-image"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="slider-image">
                                    <img src="<?php echo get_template_directory_uri() ?>/img/app-screenshots/5.jpg" alt="" class="img-responsive">
                                    <div class="preview-icon">
                                        <a href="<?php echo get_template_directory_uri() ?>/img/app-screenshots/5.jpg"><i class="icofont icofont-image"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="slider-image">
                                    <img src="<?php echo get_template_directory_uri() ?>/img/app-screenshots/8.jpg" alt="" class="img-responsive">
                                    <div class="preview-icon">
                                        <a href="<?php echo get_template_directory_uri() ?>/img/app-screenshots/8.jpg"><i class="icofont icofont-image"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="slider-image">
                                    <img src="<?php echo get_template_directory_uri() ?>/img/app-screenshots/9.jpg" alt="" class="img-responsive">
                                    <div class="preview-icon">
                                        <a href="<?php echo get_template_directory_uri() ?>/img/app-screenshots/9.jpg"><i class="icofont icofont-image"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="get-in-touch p-100">
                                    ...
                                    <p>We are still in beta testing mode. If you'd like to be notified when we have additional beta positions open, or are fully open for registration, please fill out this form and we will be in touch.</p>
                                    <form id="appai-contact-form" action="php/mail.php" method="POST" name="appai_message_form">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="your_subject" class="form-control" placeholder="Your Organization">
                                            <div class="form-grad-border"></div>
                                        </div>
                                ...
                                <div class="address-box p-100">
                                    ...
                                    <ul class="address-info">
                                        ...
                                        <li class="address">
                                            ...
                                            <div class="info-details dsp-tc">
                                                <p>6000 Meridian Dr, Suite 6
                                                    <br>Lincoln, NE 68502</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
